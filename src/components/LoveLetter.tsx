...
export function LoveLetter({ onContinue }: LoveLetterProps) {
  ...
  const lines = [
    "רומי היקרה שלי,",
    "",
    "כל רגע איתך מרגיש כמו חלום יפה",
    "שאני אף פעם לא רוצה להתעורר ממנו.",
    "",
    "את הסיבה שהלב שלי פועם חזק יותר,",
    "הסיבה שהחיוך שלי רחב יותר,",
    "והסיבה שהעולם שלי הרבה יותר צבעוני ויפה.",
    "",
    "תודה שאת פשוט את —",
    "מושלמת, מדהימה ומיוחדת.",
    "",
    "יום ולנטיין שמח, אהובתי. 💕",
  ];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative z-10 px-4 py-16" style={{ fontFamily: "'Heebo', sans-serif" }}>
      <div className="max-w-2xl w-full">
        {/* Letter paper */}
        <div className="bg-white/95 rounded-2xl shadow-2xl p-8 md:p-12 relative overflow-hidden" dir="rtl">
          {/* Decorative corner hearts */}
          <div className="absolute top-4 left-4 text-rose-200 text-2xl">♥</div>
          <div className="absolute bottom-4 right-4 text-rose-200 text-2xl">♥</div>
          ...
          >
            <p className="text-rose-400 italic text-xl">
              שלך לתמיד ולנצח
            </p>
